...
# 当我们在地址栏输入www.sina.com.cn时，浏览器将显示新浪的首页
# 通过Network的记录，我们就可以知道浏览器都干了哪些事情
...
# 继续往下找到Response Headers，点击view source，显示服务器返回的原始响应数据：
	...
	# 浏览器读取到新浪首页的HTML源码后，它会解析HTML，显示页面
	# 根据HTML里面的各种链接，再发送HTTP请求给新浪服务器，拿到相应的图片、视频、Flash、JavaScript脚本、CSS等各种资源
	# 最终显示出一个完整的页面
...
### HTTP请求
	# HTTP请求的流程：
		# 步骤1：浏览器首先向服务器发送HTTP请求，请求包括：
			# 方法：GET or POST，GET仅请求资源，POST会附带用户数据；
			# 路径：/full/url/path；
	...
	# HTTP协议同时具备极强的扩展性，虽然浏览器请求的是http://www.sina.com.cn/的首页，但是新浪在HTML中可以链入其他服务器的资源
		# <img src="http://i1.sinaimg.cn/home/2013/1008/U8455P30DT20131008135420.png">，从而将请求压力分散到各个服务器上
...
# HTTP权威指南(http://vdisk.weibo.com/s/aPgqW10HL3OHX?sudaref=www.baidu.com)
