...
/*
    ...
    没有io.h 头文件 (cygwin io.h 很奇怪！)
        ...
        mingw/include 里面有"io.h"，也定义了struct _finddata32_t、struct _finddata64_t等数据结构，但是不知道怎么使用！
...
int readtxt()
{
    ...
    const char *to_search = "D:\\Soft\\Python\\workspace\\sampleGUI\\*.py"; // 目标查找文件，*通配符
