...
// exported functions
extern T Set_new(int hint, int cmp(const void *x, const void *y), unsigned int hash(const void *x));
...
extern void Set_map(T set, void apply(const void *member, void *c1), void *c1);
